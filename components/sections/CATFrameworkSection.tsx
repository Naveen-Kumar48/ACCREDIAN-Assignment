...
export function CATFrameworkSection() {
  return (
    <section id="cat-framework" className="scroll-mt-24 px-4 py-16 sm:px-6 lg:px-8 bg-white">
      <div className="mx-auto max-w-5xl text-center">
        <div className="mb-12 space-y-3">
          <h2 className="font-display text-[2.2rem] font-bold tracking-tight text-slate-950 sm:text-[2.8rem]">
        ...
        <div className="relative mx-auto w-full max-w-4xl aspect-[1933/610]">
          <Image
